namespace WPF_N_Tier_Test.Modules.Helpers
{
    ...
    {
        public enum Currencies { UAE = 0, Syria, SaudiArabia, Tunisia, Gold, Algeria, };
    ...
    class ToWord
    {
        ...
        public string ConvertToArabic()
        {
            ...
            if (formattedNumber.Split(' ', StringSplitOptions.None)[^1] == "و") { formattedNumber = formattedNumber.Remove(formattedNumber.Length); }
            return formattedNumber;
        }
        #endregion
    }
